...
export const whyus: WhyPoint[] = [
  ...
  {
    no: "02",
    title: "Kedalaman Fullstack dan AI",
    icon: "code",
    body: "Lintang sudah merilis beberapa produk nyata yang menghasilkan pemasukan, dari platform belajar berbayar hingga sistem digitalisasi rantai pasok. Kenny membangun infrastruktur AI yang berjalan mandiri, termasuk pipeline RAG untuk dokumen keuangan Indonesia. Lapisan kecerdasan Pantik berada di tangan yang tepat.",
  },
  {
    no: "03",
