...
export const projects: Project[] = [
  {
    ...
    ringkas:
      "Lapisan aktivasi dua tingkat yang menyalakan koperasi desa terdaftar hingga membukukan penjualan pertama yang terbukti dibayar.",
    problem:
    ...
    solusi:
      "Pantik bekerja sebagai lapisan aktivasi di atas SIMKOPDES dan CoopTrade, lalu membuat keduanya benar benar berjalan. Pendamping memakainya untuk memilih koperasi yang paling perlu dinyalakan, memantik transaksi pertamanya, lalu menilai koperasi hanya dari uang yang benar benar masuk.",
    mekanisme: [
      "Peta Triage Aktivasi. Mengurutkan koperasi menurut tingkat kedormanan, dari abu-abu untuk dorman, kuning untuk denyut, oranye untuk nyala, hingga hijau untuk sehat. Pendamping langsung tahu siapa yang harus didatangi lebih dulu.",
      "Transaksi Tier-1 Terbayar. Mencocokkan koperasi dengan pembeli institusional seperti dapur SPPG dan MBG, Bulog, atau pabrik lokal, lalu menyalurkan pasokannya ke CoopTrade.",
      ...
      "Pengisian Data dan Kepatuhan Otomatis. Profil SIMKOPDES yang kosong ikut terisi dan artefak kepatuhan Permenkop 2/2024 dihasilkan otomatis sebagai hasil sampingan dari setiap aktivasi.",
    ],
    dampak:
      "Setiap koperasi yang dinyalakan Pantik berarti profil SIMKOPDES-nya terisi, komoditasnya masuk CoopTrade, keaktifannya terukur lewat Indeks Nyala, dan akses modal kerjanya terbuka lewat PO Dossier. Dengan 4.000 pendamping yang masing masing memegang sekitar 20 koperasi, sekitar 80.000 koperasi dapat dijangkau tanpa membangun basis pengguna dari nol.",
    peranTim:
